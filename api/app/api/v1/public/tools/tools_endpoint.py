...
@router.get('/', response_model=ToolListResponse, summary='Danh sách tools')
async def get_tools(
...
@router.get('/{tool_id}', response_model=ToolDetailResponse, summary='Chi tiết tool')
...
@router.post('/', response_model=ToolDetailResponse, status_code=status.HTTP_201_CREATED, summary='Tạo tool mới')
...
@router.put('/{tool_id}', response_model=ToolDetailResponse, summary='Cập nhật tool')
...
@router.delete('/{tool_id}', status_code=status.HTTP_204_NO_CONTENT, summary='Xóa tool (soft)')
