...
from app.api.v1.public.settings.settings_endpoint import router as settings_router
...
from app.api.v1.public.roles.roles_endpoint import router as roles_router
...
# App branding (name/logo) must be readable pre-login; the PUT enforces admin itself.
...
router.include_router(roles_router, prefix="/roles", dependencies=[Depends(get_current_user)])
