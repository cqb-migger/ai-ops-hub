    ...
    <div className="flex flex-col gap-[16px] sm:gap-[28px] w-full">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-[16px]">
        ...
        <button
          ...
          className="hidden md:flex items-center justify-center gap-[8px] h-[40px] px-[16px] bg-[#5570f6] text-white hover:bg-primary-600 rounded-[6px] shadow-sm font-base font-medium text-[14px] transition-all duration-200"
        >
          <PlusIcon />
      ...
      {deletingTool && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-[16px] bg-black/40 backdrop-blur-[2px]">
          <div className="w-full max-w-[440px] bg-white dark:bg-midnight-950 rounded-[16px] shadow-[0_8px_40px_rgba(23,26,31,0.18)] border border-[#dee1e6] dark:border-midnight-800 overflow-hidden">
            ...
            {/* Footer */}
            <div className="px-[16px] sm:px-[24px] py-[16px] bg-[#fafafb] dark:bg-midnight-900 border-t border-[#dee1e6] dark:border-midnight-800 flex items-center justify-between gap-[12px]">
              <button
                type="button"
                onClick={() => setDeletingTool(null)}
